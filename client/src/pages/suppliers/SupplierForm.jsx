...
import { useCreateSupplier, useSupplier, useUpdateSupplier } from '../../services/procurementApi';
import { filterSriLankanPhoneInput, validateSriLankanPhone } from '../../utils/phoneValidation';
                ...
                {f.type === 'select' ? (
                  <select name={f.name} value={form[f.name]} onChange={set} className="proc-input">
                    {f.options.map((o, index) => (
                      <option key={o} value={o} disabled={index === 0}>
                        {o}
                      </option>
                    ))}
                  </select>
                  ...
                  <div>
                    <input
                      ...
                      value={form[f.name]}
                      onChange={(e) => {
                        setForm((prev) => ({ ...prev, [f.name]: filterSriLankanPhoneInput(e.target.value) }));
