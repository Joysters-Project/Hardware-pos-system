...
import { Plus, RefreshCw, Eye, Pencil, ToggleLeft, ToggleRight } from 'lucide-react';
import { useSuppliers, useUpdateSupplierStatus } from '../../services/procurementApi';
    ...
    <div className="proc-container">
      ...
      <motion.div className="proc-header"
        ...
        <div className="proc-header-actions">
          ...
          <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}
            className="proc-btn-primary" onClick={() => navigate('/suppliers/add')}>
                    ...
                    <td>
                      <div className="proc-action-btns">
                        ...
                        <motion.button whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.9 }}
                          ...
                          onClick={() => navigate(`/suppliers/edit/${s.supplier_id}`)}>
                          <Pencil size={14} />
                        </motion.button>
                        <motion.button whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.9 }}
